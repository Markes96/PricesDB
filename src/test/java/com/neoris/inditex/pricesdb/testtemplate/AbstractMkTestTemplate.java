package com.neoris.inditex.pricesdb.testtemplate;
...
import com.neoris.inditex.pricesdb.AbstractTest;
...
import com.neoris.inditex.pricesdb.testtemplate.contextprovider.MkTestTemplateInvocationContextProvider;
import com.neoris.inditex.pricesdb.testtemplate.contextprovider.MkTestTemplateParameter;
...
public class AbstractMkTestTemplate extends AbstractTest {
  ...
  void templateTestExecutor(final MkTestTemplateParameter mkTestTemplateParameter)
      throws MkTestException, IOException, IllegalAccessException, InvocationTargetException {
  ...
  private void compareTestResult(Object testResult, final String fileName,
      final MkTestTemplate mkTestTemplate) throws MkTestException, IOException {
  ...
  protected Object filterTestResult(final Object testResult, final String[] regex)
      throws JsonProcessingException, MkTestException {
    final Object result =
        (testResult instanceof byte[]) || (testResult instanceof String) ? testResult
            : MapperUtils.writeValueAsString(testResult);
